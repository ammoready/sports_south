    ...
    before do
      stub_request(:post, "http://webservices.theshootingwarehouse.com/smart/users.asmx/GetEmailPrefs").
        with(:body => {"CustomerNumber"=>"10001", "Password"=>"secret", "Source"=>"ruby-gem", "UserName"=>"bob"},
             :headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Content-Type'=>'application/x-www-form-urlencoded', 'User-Agent'=>"sports_south rubygems.org/gems/sports_south v(#{SportsSouth::VERSION})"}).
